...
5. FileZilla 다운로드 및 연결
 <img src="./../Image/filezilla%20다운.png" width="600px" height="400px" alt="filezilla down"></img></br>
  - local에 있는 build 폴더를 서버pc로 옮겨준다.
      ...
      <img src="./../Image/filezilla%20연결%20성공.png" width="250px" height="150px" alt="filezilla 연결 성공"></img>
      3. 아래 이미지를 보면 좌측은 local의 디렉토리이고 우측은 서버pc의 디렉토리이다. 드래그로 파일을 
         옯기면 된다.
...
<img src="./../Image/apache%20접근권한%20에러.png" width="250px" height="150px" alt="apache 접근권한 에러"></img></br>
   ...
   3. build 폴더 권한 확인 및 수정
      - <img src="./../Image/apache%20build폴더%20권한%20확인.png" width="250px" height="250px" alt="apache buil폴더 권한 확인"></img></br>
